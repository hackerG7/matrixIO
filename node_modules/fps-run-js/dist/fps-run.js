(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("perf_hooks"));
	else if(typeof define === 'function' && define.amd)
		define(["perf_hooks"], factory);
	else if(typeof exports === 'object')
		exports["FpsRun"] = factory(require("perf_hooks"));
	else
		root["FpsRun"] = factory(root["perf_hooks"]);
    ...
    function FpsRun() {
        ...
        this.animate = function (now) {
            ...
            if (_this.isBrowser) {
                ...
                setImmediate(_this.animate, _this.performance.now());
